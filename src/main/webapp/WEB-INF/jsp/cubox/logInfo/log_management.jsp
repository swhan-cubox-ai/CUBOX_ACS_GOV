...
$(function() {
	...
	//modal popup set
	modalPopup ("excelAllDownloadPopup", "전체 엑셀 다운로드", 400, 490);
...
<div class="search_box mb_20">
	<div class="search_in_bline">
		...
		<div class="ch_box  mr_20">
			<input type="checkbox" id="flname" name="flname" value="flname" class="checkbox" <c:if test="${logInfoVO.flname eq 'flname'}">checked</c:if>> <label for="flname" class="ml_10"> 단말기명</label>
		...
		<div class="comm_search  mr_5">
			<input type="text" id="srchCondWord" name="srchCondWord" class="w_180px input_com l_radius_no" placeholder="검색어를 입력해 주세요" value='<c:out value="${logInfoVO.srchCondWord}"/>'>
		</div>
		</c:if>
	</div>
	<div class="search_in_bline">
	...
	<table class="tb_list">
		...
		<thead id="thHead">
			<tr id="trLog">
				...
				<th id="thcfstatus">
					<input type="hidden" id="sortcfstatus" name="thsortnm" />
					카드상태
					<span id="spcfstatus" style="float: right; margin-right: 5px;"></span>
				</th>
				<th id="thfvalue1">
