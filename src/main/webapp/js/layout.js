...
function(p) {
    var f = "menuSlider";
    function i(e, t) {
        var o, n, i, a, l = p(e), r = e;
        function s(e) {
            void 0 !== t[e] && t[e].call(r)
        }
        function c() {
            o = p("#" + t.wrapperId).outerWidth(),
            i = p.map(l.children("li:not(.nav-title)"), function(e) {
        ...
        myapp_config.root_.on("click touchend", "[data-action]", function(e) {
            ...
            case "panel-collapse" === o:
                (l = $(this).closest(".panel")).children(".panel-container").collapse("toggle").on("show.bs.collapse", function() {
                    ...
                    myapp_config.debugState && console.log("panel id:" + l.attr("id") + " | action: uncollapsed")
                }).on("hidden.bs.collapse", function() {
                    l.addClass("panel-collapsed"),
                    myapp_config.debugState && console.log("panel id:" + l.attr("id") + " | action: collapsed")
                });
                break;
            case "panel-fullscreen" === o:
                (l = $(this).closest(".panel")).toggleClass("panel-fullscreen"),
                myapp_config.root_.toggleClass("panel-fullscreen"),
                myapp_config.debugState && console.log("panel id:" + l.attr("id") + " | action: fullscreen");
                break;
            case "panel-close" === o:
                function a() {
                    l.fadeOut(500, function() {
                        $(this).remove(),
                        myapp_config.debugState && console.log("panel id:" + l.attr("id") + " | action: removed")
                    })
                }
                var l = $(this).closest(".panel");
                "undefined" != typeof bootbox ? (initApp.playSound("media/sound", "messagebox"),
                bootbox.confirm({
            ...
            case "lang" === o:
                ...
                }) : initApp.loadScript("lib/i18n.js", function() {
                    $.i18n.init({
			...
			if($("#panel-1").hasClass("panel-fullscreen")){ 
				$("button[data-action='panel-fullscreen']").attr("data-original-title","화면축소")
			}else {
				$("button[data-action='panel-fullscreen']").attr("data-original-title","화면확대")
			}
            $(this).tooltip("hide"),
...
var color = {
    primary: {
        _50: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-primary-50").css("color")) || "#e5f5f8",
        _100: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-primary-100").css("color")) || "#ccecf1",
        _200: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-primary-200").css("color")) || "#b2e3ea",
        _300: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-primary-300").css("color")) || "#99d9e3",
        _400: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-primary-400").css("color")) || "#7fd0dc",
        _500: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-primary-500").css("color")) || "#66c7d5",
        _600: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-primary-600").css("color")) || "#4cbdce",
        _700: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-primary-700").css("color")) || "#33b4c7",
        _800: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-primary-800").css("color")) || "#19aac0",
        _900: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-primary-900").css("color")) || "#00a1b9"
    },
    success: {
        _50: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-success-50").css("color")) || "#e8f7ee",
        _100: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-success-100").css("color")) || "#d1f0dd",
        _200: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-success-200").css("color")) || "#bae9cc",
        _300: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-success-300").css("color")) || "#a4e1bb",
        _400: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-success-400").css("color")) || "#8ddaaa",
        _500: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-success-500").css("color")) || "#76d39a",
        _600: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-success-600").css("color")) || "#5fcb88",
        _700: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-success-700").css("color")) || "#49c478",
        _800: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-success-800").css("color")) || "#31bc67",
        _900: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-success-900").css("color")) || "#1bb556"
    },
    info: {
        ...
        _900: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-info-900").css("color")) || "#415dc0"
    },
    warning: {
    ...
    danger: {
        _50: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-danger-50").css("color")) || "#feeeeb",
        _100: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-danger-100").css("color")) || "#fdded7",
        _200: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-danger-200").css("color")) || "#fbcdc3",
        _300: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-danger-300").css("color")) || "#fabcb0",
        _400: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-danger-400").css("color")) || "#f9ab9c",
        _500: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-danger-500").css("color")) || "#f89b88",
        _600: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-danger-600").css("color")) || "#f78a74",
        _700: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-danger-700").css("color")) || "#f57961",
        _800: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-danger-800").css("color")) || "#f4684c",
        _900: rgb2hex(myapp_config.mythemeColorProfileID.find(".color-danger-900").css("color")) || "#f35839"
    },
    fusion: {
