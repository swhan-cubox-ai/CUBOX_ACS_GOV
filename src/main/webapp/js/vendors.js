(function() {
    ...
    var l, c, e, n, r, i, o, s, a, b, u, h, y, f, p, d, g, _, w, m, v, x, C, E, T, S, k, D, I, P, N, A, O, L, j, H, M, R, q, W, F, B, U, z, Y, V, K, X, Q, $ = [].slice, G = {}.hasOwnProperty, J = [].indexOf || function(t) {
    ...
    x = function() {
        ...
        for (e = arguments[0],
        r = 0,
        s = (i = 2 <= arguments.length ? $.call(arguments, 1) : []).length; r < s; r++)
            if (n = i[r])
                for (t in n)
                    G.call(n, t) && (o = n[t],
    ...
    function it() {
        ...
        if (null != W && P.ajax.trackWebSockets) {
            window.WebSocket = function(t, e) {
                var n;
                return n = null != e ? new W(t,e) : new W(t),
    ...
    H = function(t) {
        ...
        if (!k.length && P.ajax) {
            if ("socket" === t && P.ajax.trackWebSockets)
                return !0;
            if (e = t.toUpperCase(),
            0 <= J.call(P.ajax.trackMethods, e))
                return !0
        }
        return !1
    }
    ...
    j = function(t) {
        var e, n, i, o;
        for (n = 0,
        i = (o = P.ajax.ignoreURLs).length; n < i; n++)
    ...
    (T = function() {
        ...
        n = t.url,
        !j(n))
            return b.running || !1 === P.restartOnRequestAfter && "force" !== H(a) ? void 0 : (r = arguments,
    ...
    i = function() {
        ...
        n = setInterval(function() {
            ...
            e = g(r),
            ++o >= P.eventLag.minSamples && e < P.eventLag.lagThreshold ? (s.progress = 100,
    ...
    (D = function() {
        ...
        for (n = 0,
        o = (a = null != (s = P.extraSources) ? s : []).length; n < o; n++)
            M = a[n],
            R.push(new M(P));
...
function(t, e) {
    ...
    T.extend({
        ...
        makeArray: function(t, e) {
            var n = e || [];
            return null != t && (f(Object(t)) ? T.merge(n, "string" == typeof t ? [t] : t) : l.call(n, t)),
            n
        },
    ...
    var p = function(n) {
        ...
        var t, p, _, r, s, d, f, g, w, l, c, x, C, a, E, m, u, v, b, T = "sizzle" + 1 * new Date, y = n.document, S = 0, i = 0, k = lt(), D = lt(), I = lt(), P = lt(), N = function(t, e) {
            return t === e && (c = !0),
            0
        }, A = {}.hasOwnProperty, e = [], O = e.pop, L = e.push, j = e.push, H = e.slice, M = function(t, e) {
            for (var n = 0, i = t.length; n < i; n++)
                if (t[n] === e)
                    return n;
            return -1
        }, R = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", q = "[\\x20\\t\\r\\n\\f]", W = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", F = "\\[" + q + "*(" + W + ")(?:" + q + "*([*^$|!~]?=)" + q + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + W + "))|)" + q + "*\\]", B = ":(" + W + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)", U = new RegExp(q + "+","g"), z = new RegExp("^" + q + "+|((?:^|[^\\\\])(?:\\\\.)*)" + q + "+$","g"), Y = new RegExp("^" + q + "*," + q + "*"), V = new RegExp("^" + q + "*([>+~]|" + q + ")" + q + "*"), K = new RegExp(q + "|>"), X = new RegExp(B), Q = new RegExp("^" + W + "$"), $ = {
            ID: new RegExp("^#(" + W + ")"),
            CLASS: new RegExp("^\\.(" + W + ")"),
            TAG: new RegExp("^(" + W + "|[*])"),
            ATTR: new RegExp("^" + F),
        ...
        }, G = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, tt = /^[^{]+\{\s*\[native \w/, et = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, nt = /[+~]/, it = new RegExp("\\\\([\\da-f]{1,6}" + q + "?|(" + q + ")|.)","ig"), ot = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, rt = function(t, e) {
        ...
        function at(e, t, n, i) {
            ...
            "string" != typeof e || !e || 1 !== f && 9 !== f && 11 !== f)
                return n;
            if (!i && ((t ? t.ownerDocument || t : y) !== C && x(t),
            t = t || C,
            E)) {
                if (11 !== f && (l = et.exec(e)))
                    if (o = l[1]) {
                ...
                if (p.qsa && !P[e + " "] && (!m || !m.test(e)) && (1 !== f || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    h = t,
                    1 === f && K.test(e)) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(ot, rt) : t.setAttribute("id", a = T),
                        r = (c = d(e)).length; r--; )
                            c[r] = "#" + a + " " + yt(c[r]);
                        u = c.join(","),
        ...
        at.matchesSelector = function(t, e) {
            ...
            p.matchesSelector && E && !P[e + " "] && (!u || !u.test(e)) && (!m || !m.test(e)))
                try {
                    var n = v.call(t, e);
        ...
        (_ = at.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return $.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && X.test(n) && (e = d(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                    t[2] = n.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(n, i, o) {
                    return function(t) {
                        var e = at.attr(t, n);
                        return null == e ? "!=" === i : !i || (e += "",
                        "=" === i ? e === o : "!=" === i ? e !== o : "^=" === i ? o && 0 === e.indexOf(o) : "*=" === i ? o && -1 < e.indexOf(o) : "$=" === i ? o && e.slice(-o.length) === o : "~=" === i ? -1 < (" " + e.replace(U, " ") + " ").indexOf(o) : "|=" === i && (e === o || e.slice(0, o.length + 1) === o + "-"))
                    }
                },
            ...
            pseudos: {
                ...
                lang: ct(function(n) {
                    return Q.test(n || "") || at.error("unsupported lang: " + n),
        ...
        d = at.tokenize = function(t, e) {
            ...
            l = _.preFilter; s; ) {
                ...
                s = s.slice(n.length)),
                _.filter)
                    !(i = $[r].exec(s)) || l[r] && !(i = l[r](i)) || (n = i.shift(),
                    o.push({
                        value: n,
                        type: r,
                        matches: i
        ...
        g = at.select = function(t, e, n, i) {
            ...
            1 === u.length) {
                ...
                for (o = $.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o],
                !_.relative[a = s.type]); )
    ...
    T.each({
        ...
        T.fn[i] = function(t, e) {
            ...
            1 < this.length && (O[i] || T.uniqueSort(n),
            A.test(i) && n.reverse()),
            this.pushStack(n)
        }
    });
    ...
    T.extend({
                        ...
                        return function() {
                            function t() {
                                ...
                                if (!(o < l)) {
                                    ...
                                    y(e) ? a ? e.call(t, c(l, r, H, a), c(l, r, M, a)) : (l++,
                                    e.call(t, c(l, r, H, a), c(l, r, M, a), c(l, r, H, r.notifyWith))) : (s !== H && (n = void 0,
                                    i = [t]),
                                    (a || r.resolveWith)(n, i))
                                }
                            }
        ...
        when: function(t) {
            ...
            var n = arguments.length
              ...
              , r = a.call(arguments)
              , s = T.Deferred();
            if (n <= 1 && (R(t, s.done(e(i)).resolve, s.reject, !n),
    ...
    T.ready.then = W.then,
    "complete" === E.readyState || "loading" !== E.readyState && !E.documentElement.doScroll ? C.setTimeout(T.ready) : (E.addEventListener("DOMContentLoaded", F),
        ...
        data: function(n, t) {
            ...
            if (void 0 !== n)
                return "object" == typeof n ? this.each(function() {
                    ...
                    var e;
                    if (r && void 0 === t)
                        return void 0 !== (e = $.get(r, n)) ? e : void 0 !== (e = Z(r, n)) ? e : void 0;
                    this.each(function() {
                        $.set(this, n, t)
                    })
    ...
    function lt(t, e, n, i) {
        ...
        , l = a(), c = n && n[3] || (T.cssNumber[e] ? "" : "px"), u = t.nodeType && (T.cssNumber[e] || "px" !== c && +l) && et.exec(T.css(t, e));
        if (u && u[3] !== c) {
            for (l /= 2,
            c = c || u[3],
            u = +l || 1; s--; )
    ...
    function ut(t, e) {
        for (var n, i, o, r, s, a, l, c = [], u = 0, h = t.length; u < h; u++)
            ...
            c[u] || (i.style.display = "")),
            "" === i.style.display && at(i) && (c[u] = (l = s = r = void 0,
            s = (o = i).ownerDocument,
            a = o.nodeName,
            (l = ct[a]) || (r = s.body.appendChild(s.createElement(a)),
            l = T.css(r, "display"),
            r.parentNode.removeChild(r),
            "none" === l && (l = "block"),
            ct[a] = l)))) : "none" !== n && (c[u] = "none",
            Q.set(i, "display", n)));
        for (u = 0; u < h; u++)
    ...
    T.event = {
        ...
        dispatch: function(t) {
            var e, n, i, o, r, s, a = T.event.fix(t), l = new Array(arguments.length), c = (Q.get(this, "events") || {})[a.type] || [], u = T.event.special[a.type] || {};
            for (l[0] = a,
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    var e = this || t;
                    return ht.test(e.type) && e.click && k(e, "input") && Dt(e, "click", Et),
                    !1
                },
                trigger: function(t) {
                    var e = this || t;
                    return ht.test(e.type) && e.click && k(e, "input") && Dt(e, "click"),
                    !0
                },
                _default: function(t) {
                    var e = t.target;
    ...
    function Mt(n, i, o, r) {
        ...
        if (h && (e = (t = _t(i, n[0].ownerDocument, !1, n, r)).firstChild,
    ...
    T.extend({
        ...
        clone: function(t, e, n) {
            var i, o, r, s, a, l, c, u = t.cloneNode(!0), h = ot(t);
    ...
    var qt, Wt, Ft, Bt, Ut, zt, Yt, Vt = new RegExp("^(" + tt + ")(?!px)[a-z%]+$","i"), Kt = function(t) {
    ...
    function Gt(t, e, n) {
        ...
        return (n = n || Kt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || ot(t) || (s = T.style(t, e)),
        !b.pixelBoxStyles() && Vt.test(s) && Xt.test(e) && (i = a.width,
        o = a.minWidth,
        r = a.maxWidth,
    ...
    (Yt = E.createElement("div")).style && (Yt.style.backgroundClip = "content-box",
    ...
    function le(t, e, n, i, o, r) {
        ...
        for (; s < 4; s += 2)
            ...
            i ? ("content" === n && (l -= T.css(t, "padding" + nt[s], !0, o)),
            "margin" !== n && (l -= T.css(t, "border" + nt[s] + "Width", !0, o))) : (l += T.css(t, "padding" + nt[s], !0, o),
            "padding" !== n ? l += T.css(t, "border" + nt[s] + "Width", !0, o) : a += T.css(t, "border" + nt[s] + "Width", !0, o));
    ...
    function ce(t, e, n) {
        ...
        return (!b.boxSizingReliable() && o || "auto" === s || !parseFloat(s) && "inline" === T.css(t, "display", !1, i)) && t.getClientRects().length && (o = "border-box" === T.css(t, "boxSizing", !1, i),
        (r = a in t) && (s = t[a])),
    ...
    T.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, r, s, a = V(e), l = oe.test(e), c = t.style;
                if (l || (e = ne(a)),
                s = T.cssHooks[e] || T.cssHooks[a],
                void 0 === n)
                    return s && "get"in s && void 0 !== (o = s.get(t, !1, i)) ? o : c[e];
                "string" === (r = typeof n) && (o = et.exec(n)) && o[1] && (n = lt(t, e, o),
                r = "number"),
    ...
    T.each(["height", "width"], function(t, l) {
        T.cssHooks[l] = {
            get: function(t, e, n) {
                if (e)
                    return !ie.test(T.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? ce(t, l, n) : st(t, re, function() {
                        return ce(t, l, n)
                    })
            },
            set: function(t, e, n) {
                var i, o = Kt(t), r = !b.scrollboxSize() && "absolute" === o.position, s = (r || n) && "border-box" === T.css(t, "boxSizing", !1, o), a = n ? le(t, l, n, s, o) : 0;
                return s && r && (a -= Math.ceil(t["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(o[l]) - le(t, l, "border", !1, o) - .5)),
                a && (i = et.exec(e)) && "px" !== (i[3] || "px") && (t.style[l] = e,
                e = T.css(t, l)),
                ae(0, e, a)
            }
        }
    ...
    T.cssHooks.marginLeft = Jt(b.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(Gt(t, "marginLeft")) || t.getBoundingClientRect().left - st(t, {
                marginLeft: 0
            }, function() {
    ...
    T.fx.step = {};
    var he, fe, pe, de, ge = /^(?:toggle|show|hide)$/, me = /queueHooks$/;
    function ve() {
        fe && (!1 === E.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(ve) : C.setTimeout(ve, T.fx.interval),
        T.fx.tick())
    }
    function be() {
    ...
    function we(r, t, e) {
        var n, s, i = 0, o = we.prefilters.length, a = T.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (s)
                return !1;
            for (var t = he || be(), e = Math.max(0, c.startTime + c.duration - t), n = 1 - (e / c.duration || 0), i = 0, o = c.tweens.length; i < o; i++)
                c.tweens[i].run(n);
    ...
    T.Animation = T.extend(we, {
        ...
        tweener: function(t, e) {
            ...
            ["*"]) : t.match(j)).length; i < o; i++)
                n = t[i],
                we.tweeners[n] = we.tweeners[n] || [],
                we.tweeners[n].unshift(e)
        },
        prefilters: [function(t, e, n) {
            var i, o, r, s, a, l, c, u, h = "width"in e || "height"in e, f = this, p = {}, d = t.style, g = t.nodeType && at(t), m = Q.get(t, "fxshow");
            ...
            if ((l = !T.isEmptyObject(e)) || !T.isEmptyObject(p))
                ...
                "none" === (u = T.css(t, "display")) && (c ? u = c : (ut([t], !0),
                c = t.style.display || c,
                u = T.css(t, "display"),
                ut([t]))),
    ...
    T.extend({
        attr: function(t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === t.getAttribute ? T.prop(t, e, n) : (1 === r && T.isXMLDoc(t) || (o = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? xe : void 0)),
        ...
        toggleClass: function(o, e) {
            ...
            return "boolean" == typeof e && s ? e ? this.addClass(o) : this.removeClass(o) : y(o) ? this.each(function(t) {
                ...
                if (s)
                    ...
                    void 0 !== o && "boolean" != r || ((t = ke(this)) && Q.set(this, "__className__", t),
    ...
    T.extend(T.event, {
        trigger: function(t, e, n, i) {
            ...
            if (r = h = s = n = n || E,
            3 !== n.nodeType && 8 !== n.nodeType && !Ne.test(p + T.event.triggered) && (-1 < p.indexOf(".") && (p = (d = p.split(".")).shift(),
            d.sort()),
            l = p.indexOf(":") < 0 && "on" + p,
            ...
            i || !u.trigger || !1 !== u.trigger.apply(n, e))) {
                if (!i && !u.noBubble && !g(n)) {
                    ...
                    Ne.test(a + p) || (r = r.parentNode); r; r = r.parentNode)
                        f.push(r),
                        s = r;
                ...
                for (o = 0; (r = f[o++]) && !t.isPropagationStopped(); )
                    ...
                    (c = l && r[l]) && c.apply && K(r) && (t.result = c.apply(r, e),
                    !1 === t.result && t.preventDefault());
                return t.type = p,
                i || t.isDefaultPrevented() || u._default && !1 !== u._default.apply(f.pop(), e) || !K(n) || l && y(n[p]) && !g(n) && ((s = n[l]) && (n[l] = null),
                T.event.triggered = p,
    ...
    b.createHTMLDocument = ((en = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    T.parseHTML = function(t, e, n) {
        ...
        r = !n && [],
        (o = D.exec(t)) ? [e.createElement(o[1])] : (o = _t([t], e, r),
...
function(t) {
    ...
    var u, h, p, d, g, m, v, b, _, w, x, C, E, T, S, k, D, I, P, N, A = "ui-effects-", O = y;
    function L(t, e, n) {
        var i = b[e.type] || {};
    ...
    y.extend(y.effects, {
        ...
        restore: function(t, e) {
            ...
            for (i = 0; i < e.length; i++)
                null !== e[i] && (void 0 === (n = t.data(A + e[i])) && (n = ""),
                t.css(e[i], n))
        },
...
function(t, e) {
    ...
    function q() {
        ...
        this.state = function(t, e) {
            return M(t).removeEventListener("resize", e.updateBound),
    ...
    function F(n, i) {
        Object.keys(i).forEach(function(t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && W(i[t]) && (e = "px"),
            n.style[t] = i[t] + e
        })
    }
    ...
    var G = {
        ...
        modifiers: {
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(g, m) {
                    if (j(g.instance.modifiers, "inner"))
                        return g;
    ...
    function Z(t, e) {
        ...
        Object.keys(C({}, Z.Defaults.modifiers, i.modifiers)).forEach(function(t) {
...
function(t, e) {
    ...
    d(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', v._handleDismiss(new v)),
    ...
    var b = "button"
      ...
      , A = function() {
        ...
        return t.toggle = function() {
            ...
            e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(C)),
    ...
    var O = "carousel"
      ...
      , at = function() {
        ...
        t.pause = function(t) {
            t || (this._isPaused = !0),
            this._element.querySelector(nt) && (g.triggerTransitionEnd(this._element),
            this.cycle(!0)),
        ...
        t._addTouchEventListeners = function() {
            ...
            if (this._touchSupported) {
                var n = function(t) {
                  ...
                  , i = function(t) {
                    e._pointerEvent && st[t.originalEvent.pointerType.toUpperCase()] && (e.touchDeltaX = t.originalEvent.clientX - e.touchStartX),
                    e._handleSwipe(),
        ...
        t._slide = function(t, e) {
            var n, i, o, r = this, s = this._element.querySelector(Z), a = this._getItemIndex(s), l = e || s && this._getItemByDirection(t, s), c = this._getItemIndex(l), u = Boolean(this._interval);
            if (o = t === q ? (n = X,
            i = Q,
            F) : (n = K,
            i = $,
            ...
            l && d(l).hasClass(Y))
                ...
                if (d(this._element).hasClass(V)) {
                    ...
                    d(s).one(g.TRANSITION_END, function() {
                        d(l).removeClass(n + " " + i).addClass(Y),
    ...
    var lt = "collapse"
      ...
      , Ct = function() {
        ...
        t.show = function() {
            ...
            !(t && (e = d(t).not(this._selector).data(ct)) && e._isTransitioning))) {
                ...
                !i.isDefaultPrevented()) {
                    ...
                    d(this._element).removeClass(mt).addClass(vt),
                    this._element.style[o] = 0,
                    this._triggerArray.length && d(this._triggerArray).removeClass(bt).attr("aria-expanded", !0),
                    this.setTransitioning(!0);
                    var r = "scroll" + (o[0].toUpperCase() + o.slice(1))
                      , s = g.getTransitionDurationFromElement(this._element);
                    d(this._element).one(g.TRANSITION_END, function() {
                        d(n._element).removeClass(vt).addClass(mt).addClass(gt),
                        n._element.style[o] = "",
        ...
        t.hide = function() {
            ...
            if (!this._isTransitioning && d(this._element).hasClass(gt)) {
                ...
                !e.isDefaultPrevented()) {
                    ...
                    d(this._element).addClass(vt).removeClass(mt).removeClass(gt);
                    ...
                    if (0 < i)
                        for (var o = 0; o < i; o++) {
                            var r = this._triggerArray[o]
                              , s = g.getSelectorFromElement(r);
                            if (null !== s)
                                d([].slice.call(document.querySelectorAll(s))).hasClass(gt) || d(r).addClass(bt).attr("aria-expanded", !1)
                        }
                    this.setTransitioning(!0);
                    ...
                    d(this._element).one(g.TRANSITION_END, function() {
                        ...
                        d(t._element).removeClass(vt).addClass(mt).trigger(dt.HIDDEN)
      ...
      , Gt = function() {
                ...
                !e) {
                    ...
                    !i.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            "scrollParent" !== this._config.boundary && d(t).addClass(Mt),
                            this._popper = new h(o,this._menu,this._getPopperConfig())
                        }
                        "ontouchstart"in document.documentElement && 0 === d(t).closest(Ft).length && d(document.body).children().on("mouseover", null, d.noop),
                        this._element.focus(),
                        this._element.setAttribute("aria-expanded", !0),
                        d(this._menu).toggleClass(At),
                        d(t).toggleClass(At).trigger(d.Event(Pt.SHOWN, n))
                    }
                }
            }
        }
        ...
        t.show = function() {
            if (!(this._element.disabled || d(this._element).hasClass(Nt) || d(this._menu).hasClass(At))) {
                ...
                d(n).trigger(e),
                e.isDefaultPrevented() || (d(this._menu).toggleClass(At),
                d(n).toggleClass(At).trigger(d.Event(Pt.SHOWN, t)))
            }
        }
        ,
        t.hide = function() {
            if (!this._element.disabled && !d(this._element).hasClass(Nt) && d(this._menu).hasClass(At)) {
                ...
                d(n).trigger(e),
                e.isDefaultPrevented() || (d(this._menu).toggleClass(At),
                d(n).toggleClass(At).trigger(d.Event(Pt.HIDDEN, t)))
            }
        }
        ,
        t.dispose = function() {
        ...
        t._getPlacement = function() {
            var t = d(this._element.parentNode)
              , e = Yt;
            return t.hasClass(Ot) ? (e = Ut,
            d(this._menu).hasClass(Ht) && (e = zt)) : t.hasClass(Lt) ? e = Kt : t.hasClass(jt) ? e = Xt : d(this._menu).hasClass(Ht) && (e = Vt),
            e
        }
        ,
                ...
                for (var e = [].slice.call(document.querySelectorAll(Rt)), n = 0, i = e.length; n < i; n++) {
                    ...
                    r) {
                        ...
                        if (d(o).hasClass(At) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && d.contains(o, t.target))) {
                            ...
                            d(a).removeClass(At),
                            d(o).removeClass(At).trigger(d.Event(Pt.HIDDEN, s)))
                        }
                    }
                }
        }
        ...
        c._dataApiKeydownHandler = function(t) {
            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || d(t.target).closest(Wt).length)) : It.test(t.which)) && (t.preventDefault(),
            t.stopPropagation(),
    ...
    var Jt = "modal"
      ...
      , ve = function() {
        ...
        t._showElement = function(t) {
            ...
            d(this._dialog).hasClass(re) ? this._dialog.querySelector(fe).scrollTop = 0 : this._element.scrollTop = 0,
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function(t, e) {
            ...
            o.forEach(function(t) {
                !function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n))
                        return -1 === be.indexOf(n) || Boolean(t.nodeValue.match(_e) || t.nodeValue.match(we));
    ...
    var Ce = "tooltip"
      ...
      , ze = function() {
        ...
        t.hide = function(t) {
            function e() {
                n._hoverState !== Oe && i.parentNode && i.parentNode.removeChild(i),
                n._cleanTipClass(),
        ...
        t.setContent = function() {
            ...
            this.setElementContent(d(t.querySelectorAll(Re)), this.getTitle()),
        ...
        t._enter = function(t, e) {
            ...
            d(e.getTipElement()).hasClass(Me) || e._hoverState === Oe ? e._hoverState = Oe : (clearTimeout(e._timeout),
            e._hoverState = Oe,
        ...
        t._fixTransition = function() {
            ...
            null === t.getAttribute("x-placement") && (d(t).removeClass(He),
    ...
    var sn = "scrollspy"
      ...
      , Tn = function() {
        function n(t, e) {
            ...
            this._config = this._getConfig(e),
            this._selector = this._config.target + " " + vn + "," + this._config.target + " " + yn + "," + this._config.target + " " + wn,
            this._offsets = [],
            this._targets = [],
        ...
        t._getConfig = function(t) {
            ...
            return g.typeCheckConfig(sn, t, hn),
            t
        }
        ,
        ...
        t._activate = function(e) {
            ...
            n.hasClass(pn) ? (n.closest(_n).find(xn).addClass(dn),
            n.addClass(dn)) : (n.addClass(dn),
            n.parents(mn).prev(vn + ", " + yn).addClass(dn),
            n.parents(mn).prev(bn).children(vn).addClass(dn)),
      ...
      , Bn = function() {
        ...
        return t.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && d(this._element).hasClass(Nn) || d(this._element).hasClass(An))) {
                var t, i, e = d(this._element).closest(Hn)[0], o = g.getSelectorFromElement(this._element);
                if (e) {
    ...
    d(document).on(In.CLICK_DATA_API, qn, function(t) {
        t.preventDefault(),
        Bn._jQueryInterface.call(d(this), "show")
    }),
    ...
    var Un = "toast"
      ...
      , ei = function() {
        ...
        t.hide = function(t) {
            var e = this;
            this._element.classList.contains($n) && (d(this._element).trigger(Kn.HIDE),
        ...
        t.dispose = function() {
            clearTimeout(this._timeout),
            this._timeout = null,
            this._element.classList.contains($n) && this._element.classList.remove($n),
        ...
        ,
        t._getConfig = function(t) {
            return t = l({}, Zn, d(this._element).data(), "object" == typeof t && t ? t : {}),
...
function(D) {
    D.fn.extend({
        slimScroll: function(S) {
            ...
            return this.each(function() {
                var i, e, o, n, r, s, a, l, c = "<div></div>", u = 30, h = !1, f = D(this);
                if (f.parent().hasClass(k.wrapperClass)) {
                    ...
                    x(0, !0)) : "top" !== k.start && (x(D(k.start).position().top, null, !0),
                ...
                function w(t) {
                    if (i) {
                        ...
                        D(n).closest("." + k.wrapperClass).is(f.parent()) && x(e, !0),
